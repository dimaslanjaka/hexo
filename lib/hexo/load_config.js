...
module.exports = async ctx => {
  ...
  ctx.log.info({ from_theme_dir: themeDirFromThemes, from_project_node_modules: themeDirFromNodeModules, from_root_yarn_node_modules: themeDirFromYarnNodeModules });
