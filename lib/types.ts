...
import type {
  ...
  time,
  time_tag
} from './plugins/helper/date.js';
import type { inspectObject, log } from './plugins/helper/debug.js';
import type favicon_tag from './plugins/helper/favicon_tag.js';
import type feed_tag from './plugins/helper/feed_tag.js';
import type { escapeHTML, stripHTML, titlecase, truncate, word_wrap } from './plugins/helper/format.js';
import type fragment_cache from './plugins/helper/fragment_cache.js';
import type full_url_for from './plugins/helper/full_url_for.js';
import type gravatar from './plugins/helper/gravatar.js';
import type image_tag from './plugins/helper/image_tag.js';
import type {
  archive,
  category,
  current,
  ...
  tag,
  year
} from './plugins/helper/is.js';
import type js from './plugins/helper/js.js';
import type link_to from './plugins/helper/link_to.js';
import type list_archives from './plugins/helper/list_archives.js';
import type list_categories from './plugins/helper/list_categories.js';
import type list_posts from './plugins/helper/list_posts.js';
import type list_tags from './plugins/helper/list_tags.js';
import type mail_to from './plugins/helper/mail_to.js';
import type markdown from './plugins/helper/markdown.js';
import type meta_generator from './plugins/helper/meta_generator.js';
import type number_format from './plugins/helper/number_format.js';
import type open_graph from './plugins/helper/open_graph.js';
import type paginator from './plugins/helper/paginator.js';
import type relative_url from './plugins/helper/relative_url.js';
import type render from './plugins/helper/render.js';
import type search_form from './plugins/helper/search_form.js';
import type tag_cloud from './plugins/helper/tagcloud.js';
import type toc from './plugins/helper/toc.js';
import type url_for from './plugins/helper/url_for.js';
import { StoreFunctionData } from './extend/renderer.js';
...
type StoreReturnType = BaseGeneratorReturn | BaseGeneratorReturn[];
type StoreFunctionReturn = Promise<StoreReturnType>;
