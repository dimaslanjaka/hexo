...
import type { titlecase, word_wrap, truncate, stripHTML, escapeHTML } from './plugins/helper/format.js';
...
import type { current, home, home_first_page, post, page, archive, year, month, category, tag } from './plugins/helper/is.js';
