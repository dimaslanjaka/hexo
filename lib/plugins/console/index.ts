  ...
  console.register(
    ...
    'Get or set configurations.',
    {
      ...
      arguments: [
        ...
        {
          name: 'value',
          desc: 'New value of a setting. Leave it blank if you just want to show a single configuration.'
        }
      ]
    },
    require('./config.js')
  ...
  console.register(
    ...
    'Render files with renderer plugins.',
    {
      ...
      options: [
        {
          name: '--output',
          desc: 'Output destination. Result will be printed in the terminal if the output destination is not set.'
        },
